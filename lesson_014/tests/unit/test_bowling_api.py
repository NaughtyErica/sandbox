# -*- coding: utf-8 -*-
# Запуск тестов командой pytest -v -k test_bowling_api.py
...
@pytest.mark.parametrize(argnames="game_result, score", argvalues=GAME_RESULT_LIST)
def test_get_score_function_result(game_result, score):
