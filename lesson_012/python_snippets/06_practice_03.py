...
class PageSizer(multiprocessing.Process):
    ...
    def run(self):
        """
        Переопределенный метод родительского класса. Предназначен для:
